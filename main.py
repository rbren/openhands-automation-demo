...
def _build_review_prompt(repo: str, pr: dict, head_sha: str, label_event: dict) -> str:
    ...
    return (
        ...
        "   Also check the repository for its own review guidance: any other skills under "
        "`.agents/skills/` or `.openhands/skills/`, and `AGENTS.md` at the repository root. "
        "If present, read them and follow their instructions too; repository-specific guidance "
        "takes precedence where it conflicts with the general methodology.\n"
